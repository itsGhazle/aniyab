function Main() {
  return (
    <>
      <h1 className=" text-center text-zinc-800 text-2xl font-medium leading-10 mt-8 mb-8">
        محصولات آنی یاب
      </h1>
      <main className="flex flex-col md:flex-row  justify-evenly flex-wrap">
        <div className="flex flex-col  border   w-80  p-4 bg-white   border-stone-200 gap-3 rounded-xl justify-center items-center  ">
          ...
          <div>
            <div className="flex flex-row justify-between">
              ...
              <p className="h-6 px-2 relative  bg-green-50 rounded-xl">
            ...
            <div className="mt-4 h-6 flex flex-row justify-between items-center ">
